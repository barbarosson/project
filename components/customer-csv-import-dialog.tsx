...
const TEMPLATE_DATA_TR: string[][] = [
  ...
  ['Örnek Şube Ankara', 'Fatma Kaya', 'müşteri', 'Çankaya VD', '1234567890', 'VKN', 'ankara@ornek.com', '05321112233', 'Tunalı Hilmi Cad. No:10', 'Ankara', 'Çankaya', '06690', 'Türkiye', 'TRY', '30', 'gün', 'net', 'Garanti Bankası', 'Örnek Şube Ankara', '99887766', 'TR00 0000 0000 0000 0000 0000 03', 'Tunalı Şubesi', '', '', 'Teknoloji', 'Şube adresi ve banka bilgileri opsiyonel', 'hayır', 'aktif', 'şube', 'ANK-01', '0'],
]
...
const TEMPLATE_DATA_EN: string[][] = [
  ...
  ['Example Branch Ankara', 'Jane Doe', 'customer', 'Central Tax Office', '1234567890', 'VKN', 'ankara@example.com', '+901234567899', '10 Branch Street', 'Ankara', 'Cankaya', '06690', 'Turkey', 'TRY', '30', 'days', 'net', 'Branch Bank', 'Example Branch Ankara', '99887766', 'TR00 0000 0000 0000 0000 0000 03', 'Central Branch', '', '', 'Technology', 'Branch address and bank optional', 'false', 'active', 'branch', 'ANK-01', '0'],
]
