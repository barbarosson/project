  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          'absolute right-2 top-2 inline-flex items-center justify-center rounded border px-1.5 py-0.5 text-[10px] font-medium',
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      'flex flex-col space-y-1.5 text-center sm:text-left pr-24',
      className
    )}
    {...props}
  />
