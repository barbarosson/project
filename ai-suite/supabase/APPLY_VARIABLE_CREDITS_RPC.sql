-- ============================================================================
-- Run in Supabase → SQL Editor if you already applied an OLD billing setup
-- (6-arg charge_and_create_request) and the app errors with:
--   "Could not find the function public.charge_and_create_request(..., p_credit_cost)"
--
-- This matches migration `20260514100000_isendai_variable_credits_and_billing_meta.sql`.
-- After run, wait ~10s and retry (NOTIFY reloads PostgREST schema cache).
-- ============================================================================
