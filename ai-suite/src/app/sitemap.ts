...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/free-credits`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/install`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
