...
export const DICTS: Record<Locale, Dict> = {
  en: {
    ...
    "login.creditsMax": "Up to {max} versions per generation (guest)",
    "login.creditsHint":
  ...
  es: {
    ...
    "login.creditsMax": "Hasta {max} versiones por generación (invitado)",
    "login.creditsHint":
  ...
  fr: {
    ...
    "login.creditsMax": "Jusqu’à {max} versions par génération (invité)",
    "login.creditsHint":
  ...
  de: {
    ...
    "login.creditsMax": "Bis zu {max} Versionen pro Generierung (Gast)",
    "login.creditsHint":
  ...
  zh: {
    ...
    "login.creditsMax": "访客：每次生成最多 {max} 个版本",
  ...
  tr: {
    ...
    "login.creditsMax": "Misafir: üretim başına en fazla {max} sürüm",
    "login.creditsHint":
