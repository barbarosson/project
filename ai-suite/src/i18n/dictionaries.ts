...
export const DICTS: Record<Locale, Dict> = {
  en: {
    ...
    "usage.chargedLine": "Credits charged: {charged}",
  ...
  es: {
    ...
    "usage.chargedLine": "Créditos usados: {charged}",
    ...
    "request.timeCreditsLine": "{date} · Créditos usados: {charged}",
    ...
    "home.creditsSummary": "Créditos: {credits} · {scope}",
  ...
  fr: {
    ...
    "usage.chargedLine": "Crédits utilisés : {charged}",
  ...
  de: {
    ...
    "usage.chargedLine": "Credits verbraucht: {charged}",
    ...
    "request.timeCreditsLine": "{date} · Credits verbraucht: {charged}",
  ...
  zh: {
    ...
    "usage.rerun": "重新运行",
    "usage.modelLabel": "模型",
    "usage.chargedLine": "已扣额度：{charged}",
    ...
    "request.timeCreditsLine": "{date} · 已扣额度：{charged}",
    "request.inputStored": "已保存输入",
    "request.versions": "版本",
    "request.versionLine": "版本 {idx}",
    "request.noVersions": "尚无已保存版本。",
    "home.creditsSummary": "额度：{credits} · {scope}",
  ...
  tr: {
    ...
    "usage.modelLabel": "Model",
    "usage.chargedLine": "Harcanan kontör: {charged}",
    ...
    "request.timeCreditsLine": "{date} · Harcanan kontör: {charged}",
    ...
    "home.creditsSummary": "Kontör: {credits} · {scope}",
