...
export const DICTS: Record<Locale, Dict> = {
  en: {
    ...
    "pricing.subtitle":
      "Monthly bundles: 500 / 1,000 / 5,000 requests at $7.99 / $9.99 / $19.99 per month. Annual options: $79 / $99 / $199 per year (same tiers, ~17% vs paying monthly). Custom mixes estimate price from those rates. Pay-as-you-go 10-request packs gate model tiers. Each run uses 1 credit.",
    "pricing.monthly.sectionTitle": "Monthly request bundles",
    "pricing.monthly.sectionLead":
      "Renews each billing cycle once Stripe is enabled. Effective per-request rates: ~$0.016 (500), ~$0.010 (1,000), ~$0.004 (5,000).",
    "pricing.monthly.starter.name": "Starter",
    "pricing.monthly.starter.price": "$7.99",
    "pricing.monthly.starter.requests": "500 requests / month",
    ...
    "pricing.yearly.sectionLead":
      "Same three tiers as monthly, billed once per year. Yearly totals: 6,000 / 12,000 / 60,000 requests (equivalent to 500 / 1,000 / 5,000 per month).",
    "pricing.yearly.starter.price": "$79 / year",
    "pricing.yearly.starter.requests": "6,000 requests / year",
    ...
    "pricing.yearly.growth.requests": "12,000 requests / year",
    ...
    "pricing.yearly.scale.requests": "60,000 requests / year",
    ...
    "pricing.custom.subtitle":
      "Split monthly requests across low / mid / high AI tiers. Totals use per-request rates derived from our bundles: $19.99÷5000 (low), $9.99÷1000 (mid), $7.99÷500 (high).",
    ...
    "pricing.custom.lowRateHint": "≈ {rate} / request (from $19.99 / 5000)",
    "pricing.custom.midRateHint": "≈ {rate} / request (from $9.99 / 1000)",
    "pricing.custom.highRateHint": "≈ {rate} / request (from $7.99 / 500)",
  ...
  es: {
    ...
    "pricing.subtitle":
      "Mensual: 500 / 1.000 / 5.000 solicitudes por $7.99 / $9.99 / $19.99 al mes. Anual: $79 / $99 / $199 al año (mismos niveles, ~17 % menos que pagar mensual). Las mezclas personalizadas usan esas tarifas. Los packs de 10 solicitudes limitan modelos. Cada ejecución usa 1 crédito.",
    "pricing.monthly.sectionTitle": "Paquetes mensuales de solicitudes",
    "pricing.monthly.sectionLead":
      "Se renueva cada ciclo cuando Stripe esté activo. Precios por solicitud aprox.: ~$0.016 (500), ~$0.010 (1.000), ~$0.004 (5.000).",
    "pricing.monthly.starter.name": "Inicial",
    "pricing.monthly.starter.price": "$7.99",
    "pricing.monthly.starter.requests": "500 solicitudes / mes",
    "pricing.monthly.starter.desc": "Volumen mensual de entrada.",
    "pricing.monthly.growth.name": "Crecimiento",
    "pricing.monthly.growth.price": "$9.99",
    "pricing.monthly.growth.requests": "1.000 solicitudes / mes",
    "pricing.monthly.growth.desc": "Uso diario constante.",
    "pricing.monthly.scale.name": "Escala",
    "pricing.monthly.scale.price": "$19.99",
    "pricing.monthly.scale.requests": "5.000 solicitudes / mes",
    "pricing.monthly.scale.desc": "Alto volumen y mejor precio por solicitud.",
    "pricing.yearly.sectionTitle": "Paquetes anuales",
    "pricing.yearly.sectionLead":
      "Los mismos tres niveles que el mensual, facturados una vez al año. Totales anuales: 6.000 / 12.000 / 60.000 solicitudes (equivalente a 500 / 1.000 / 5.000 al mes).",
    "pricing.yearly.starter.price": "$79 / año",
    "pricing.yearly.starter.requests": "6.000 solicitudes / año",
    ...
    "pricing.yearly.growth.requests": "12.000 solicitudes / año",
    ...
    "pricing.yearly.scale.requests": "60.000 solicitudes / año",
    ...
    "pricing.custom.subtitle":
      "Reparte solicitudes mensuales entre niveles bajo / medio / alto. Total con tasas de $19.99÷5000 (bajo), $9.99÷1000 (medio), $7.99÷500 (alto).",
    ...
    "pricing.custom.lowRateHint": "≈ {rate} / solicitud (de $19.99 / 5000)",
    "pricing.custom.midRateHint": "≈ {rate} / solicitud (de $9.99 / 1000)",
    "pricing.custom.highRateHint": "≈ {rate} / solicitud (de $7.99 / 500)",
  ...
  fr: {
    ...
    "pricing.subtitle":
      "Mensuel : 500 / 1 000 / 5 000 requêtes pour $7.99 / $9.99 / $19.99 par mois. Annuel : $79 / $99 / $199 par an (mêmes niveaux, ~17 % de moins que le mensuel sur 12 mois). Le mix personnalisé reprend ces tarifs. Les packs de 10 requêtes limitent les modèles. Chaque exécution utilise 1 crédit.",
    "pricing.monthly.sectionTitle": "Forfaits mensuels de requêtes",
    "pricing.monthly.sectionLead":
      "Renouvellement à chaque cycle une fois Stripe activé. Tarifs par requête indicatifs : ~$0.016 (500), ~$0.010 (1 000), ~$0.004 (5 000).",
    "pricing.monthly.starter.name": "Starter",
    "pricing.monthly.starter.price": "7,99 $",
    "pricing.monthly.starter.requests": "500 requêtes / mois",
    "pricing.monthly.starter.desc": "Volume mensuel d’entrée.",
    "pricing.monthly.growth.name": "Croissance",
    "pricing.monthly.growth.price": "9,99 $",
    "pricing.monthly.growth.requests": "1 000 requêtes / mois",
    "pricing.monthly.growth.desc": "Usage quotidien régulier.",
    "pricing.monthly.scale.name": "Échelle",
    "pricing.monthly.scale.price": "19,99 $",
    "pricing.monthly.scale.requests": "5 000 requêtes / mois",
    "pricing.monthly.scale.desc": "Gros volume et meilleur prix par requête.",
    "pricing.yearly.sectionTitle": "Forfaits annuels",
    "pricing.yearly.sectionLead":
      "Les trois mêmes niveaux qu’en mensuel, facturés une fois par an. Totaux annuels : 6 000 / 12 000 / 60 000 requêtes (équivalent à 500 / 1 000 / 5 000 par mois).",
    "pricing.yearly.starter.price": "79 $ / an",
    "pricing.yearly.starter.requests": "6 000 requêtes / an",
    ...
    "pricing.yearly.growth.requests": "12 000 requêtes / an",
    ...
    "pricing.yearly.scale.requests": "60 000 requêtes / an",
    ...
    "pricing.custom.subtitle":
      "Répartis tes requêtes mensuelles entre niveaux bas / moyen / haut. Total basé sur $19.99÷5000 (bas), $9.99÷1000 (moyen), $7.99÷500 (haut).",
    ...
    "pricing.custom.lowRateHint": "≈ {rate} / requête (à partir de $19.99 / 5000)",
    "pricing.custom.midRateHint": "≈ {rate} / requête (à partir de $9.99 / 1000)",
    "pricing.custom.highRateHint": "≈ {rate} / requête (à partir de $7.99 / 500)",
  ...
  de: {
    ...
    "pricing.subtitle":
      "Monatlich: 500 / 1.000 / 5.000 Requests für $7.99 / $9.99 / $19.99 pro Monat. Jährlich: $79 / $99 / $199 pro Jahr (gleiche Stufen, ~17 % weniger als 12× Monatspreis). Individuelle Mixe nutzen dieselben Stückpreise. 10er‑Packs begrenzen die Modellwahl. Ein Lauf = 1 Credit.",
    "pricing.monthly.sectionTitle": "Monatliche Request‑Pakete",
    "pricing.monthly.sectionLead":
      "Verlängert sich pro Abrechnungszyklus mit Stripe. Ca. Preis pro Request: ~$0.016 (500), ~$0.010 (1.000), ~$0.004 (5.000).",
    "pricing.monthly.starter.name": "Starter",
    "pricing.monthly.starter.price": "7,99 $",
    "pricing.monthly.starter.requests": "500 Requests / Monat",
    "pricing.monthly.starter.desc": "Einstieg für wenig Volumen.",
    "pricing.monthly.growth.name": "Growth",
    "pricing.monthly.growth.price": "9,99 $",
    "pricing.monthly.growth.requests": "1.000 Requests / Monat",
    "pricing.monthly.growth.desc": "Regelmäßige tägliche Nutzung.",
    "pricing.monthly.scale.name": "Scale",
    "pricing.monthly.scale.price": "19,99 $",
    "pricing.monthly.scale.requests": "5.000 Requests / Monat",
    "pricing.monthly.scale.desc": "Hohes Volumen, bester Stückpreis.",
    "pricing.yearly.sectionTitle": "Jahrespakete",
    "pricing.yearly.sectionLead":
      "Dieselben drei Stufen wie monatlich, einmal pro Jahr abgerechnet. Jahresgesamt: 6.000 / 12.000 / 60.000 Requests (wie 500 / 1.000 / 5.000 pro Monat).",
    "pricing.yearly.starter.price": "79 $ / Jahr",
    "pricing.yearly.starter.requests": "6.000 Requests / Jahr",
    ...
    "pricing.yearly.growth.requests": "12.000 Requests / Jahr",
    ...
    "pricing.yearly.scale.requests": "60.000 Requests / Jahr",
    ...
    "pricing.custom.subtitle":
      "Verteile monatliche Requests auf niedrige / mittlere / hohe KI‑Stufen. Summe aus $19.99÷5000 (niedrig), $9.99÷1000 (mittel), $7.99÷500 (hoch).",
    ...
    "pricing.custom.lowRateHint": "≈ {rate} / Request (aus $19.99 / 5000)",
    "pricing.custom.midRateHint": "≈ {rate} / Request (aus $9.99 / 1000)",
    "pricing.custom.highRateHint": "≈ {rate} / Request (aus $7.99 / 500)",
  ...
  zh: {
    ...
    "pricing.title": "价格与套餐",
    "pricing.subtitle":
      "月付：500 / 1,000 / 5,000 次请求（$7.99 / $9.99 / $19.99 / 月）。年付：$79 / $99 / $199 / 年（同档，约比连续月付省 17%）。自定义配比按相同单价推算。10 次额度包限制模型档位。每次生成消耗 1 额度。",
    "pricing.monthly.sectionTitle": "月度请求套餐",
    "pricing.monthly.sectionLead":
      "Stripe 开通后按账单周期续订。单次参考成本：约 $0.016（500）、$0.010（1,000）、$0.004（5,000）。",
    "pricing.monthly.starter.name": "入门",
    "pricing.monthly.starter.price": "$7.99",
    "pricing.monthly.starter.requests": "每月 500 次请求",
    "pricing.monthly.starter.desc": "轻量个人使用。",
    "pricing.monthly.growth.name": "成长",
    "pricing.monthly.growth.price": "$9.99",
    "pricing.monthly.growth.requests": "每月 1,000 次请求",
    "pricing.monthly.growth.desc": "稳定日常使用。",
    "pricing.monthly.scale.name": "规模",
    "pricing.monthly.scale.price": "$19.99",
    "pricing.monthly.scale.requests": "每月 5,000 次请求",
    "pricing.monthly.scale.desc": "高频与自动化场景，单次成本更低。",
    "pricing.yearly.sectionTitle": "年度套餐",
    "pricing.yearly.sectionLead":
      "与月度三档一致，按年计费。年度总量：6,000 / 12,000 / 60,000 次请求（相当于每月 500 / 1,000 / 5,000）。",
    "pricing.yearly.starter.price": "$79 / 年",
    "pricing.yearly.starter.requests": "每年 6,000 次请求",
    ...
    "pricing.yearly.growth.requests": "每年 12,000 次请求",
    ...
    "pricing.yearly.scale.requests": "每年 60,000 次请求",
    ...
    "pricing.custom.subtitle":
      "把月度请求分配到低 / 中 / 高三档模型用量。总价按 $19.99÷5000（低）、$9.99÷1000（中）、$7.99÷500（高）估算。",
    "pricing.custom.lowLabel": "低档 AI 请求次数",
    "pricing.custom.midLabel": "中档 AI 请求次数",
    "pricing.custom.highLabel": "高档 AI 请求次数",
    "pricing.custom.lowRateHint": "≈ {rate} / 次（来自 $19.99 / 5000）",
    "pricing.custom.midRateHint": "≈ {rate} / 次（来自 $9.99 / 1000）",
    "pricing.custom.highRateHint": "≈ {rate} / 次（来自 $7.99 / 500）",
  ...
  tr: {
    ...
    "pricing.subtitle":
      "Aylık: 500 / 1.000 / 5.000 istek ($7.99 / $9.99 / $19.99 / ay). Yıllık: $79 / $99 / $199 / yıl (aynı kademeler, aylığa göre ~%17 daha uygun). Özel dağılım aynı birim fiyatlarla hesaplanır. 10’luk paketler model erişimini sınırlar. Her çalıştırma 1 kontör.",
    "pricing.monthly.sectionTitle": "Aylık istek paketleri",
    "pricing.monthly.sectionLead":
      "Stripe açılınca her fatura döneminde yenilenir. Yaklaşık istek başı: ~$0.016 (500), ~$0.010 (1.000), ~$0.004 (5.000).",
    "pricing.monthly.starter.name": "Başlangıç",
    "pricing.monthly.starter.price": "$7.99",
    "pricing.monthly.starter.requests": "Ayda 500 istek",
    "pricing.monthly.starter.desc": "Bireysel hafif kullanım.",
    "pricing.monthly.growth.name": "Büyüme",
    "pricing.monthly.growth.price": "$9.99",
    "pricing.monthly.growth.requests": "Ayda 1.000 istek",
    "pricing.monthly.growth.desc": "Düzenli günlük kullanım.",
    "pricing.monthly.scale.name": "Ölçek",
    "pricing.monthly.scale.price": "$19.99",
    "pricing.monthly.scale.requests": "Ayda 5.000 istek",
    ...
    "pricing.yearly.sectionLead":
      "Aylık üç kademeyle aynı; yılda bir kez faturalanır. Yıllık toplamlar: 6.000 / 12.000 / 60.000 istek (ayda 500 / 1.000 / 5.000 ile eşdeğer).",
    "pricing.yearly.starter.price": "$79 / yıl",
    "pricing.yearly.starter.requests": "Yılda 6.000 istek",
    ...
    "pricing.yearly.growth.requests": "Yılda 12.000 istek",
    ...
    "pricing.yearly.scale.requests": "Yılda 60.000 istek",
    ...
    "pricing.custom.subtitle":
      "Düşük / orta / yüksek model katmanlarına aylık istek sayılarını böl. Toplam: $19.99÷5000 (düşük), $9.99÷1000 (orta), $7.99÷500 (yüksek) birim fiyatlarıyla.",
    ...
    "pricing.custom.lowRateHint": "≈ {rate} / istek ($19.99 / 5000)",
    "pricing.custom.midRateHint": "≈ {rate} / istek ($9.99 / 1000)",
    "pricing.custom.highRateHint": "≈ {rate} / istek ($7.99 / 500)",
