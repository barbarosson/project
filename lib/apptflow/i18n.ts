...
const CATALOGS: Record<LocaleCode, Catalog> = {
  en: {
    ...
    ask_service_choice: 'Which service would you like? {services}. Reply with a number or the name.',
    service_picked: 'Great — {service}.',
    service_not_matched: 'Sorry, I could not match that service. Options: {services}. Reply with a number or the name.',
    price_list: 'Our services: {items}.',
    price_list_empty: 'We have not set up a service menu yet. Please try again soon.',
  ...
  tr: {
    ...
    ask_service_choice: 'Hangi hizmet için randevu istersiniz? {services}. Numara veya hizmet adı yazabilirsiniz.',
    service_picked: 'Harika — {service}.',
    service_not_matched: 'Hizmeti eşleştiremedim. Seçenekler: {services}. Numara veya isim yazın.',
    price_list: 'Hizmetlerimiz: {items}.',
    price_list_empty: 'Henüz bir hizmet listemiz tanımlı değil. Kısa süre içinde tekrar deneyin.',
  ...
  es: {
    ...
    ask_service_choice: '¿Qué servicio deseas? {services}. Responde con un número o el nombre.',
    service_picked: 'Perfecto — {service}.',
    service_not_matched: 'No pude identificar el servicio. Opciones: {services}. Responde con un número o el nombre.',
    price_list: 'Nuestros servicios: {items}.',
    price_list_empty: 'Aún no hay un menú de servicios. Intenta de nuevo pronto.',
  ...
  de: {
    ...
    ask_service_choice: 'Welche Leistung möchtest du? {services}. Antworte mit einer Nummer oder dem Namen.',
    service_picked: 'Super — {service}.',
    service_not_matched: 'Ich konnte die Leistung nicht zuordnen. Optionen: {services}. Antworte mit einer Nummer oder dem Namen.',
    price_list: 'Unsere Leistungen: {items}.',
    price_list_empty: 'Wir haben noch keine Leistungsliste. Bitte später erneut versuchen.',
  ...
  fr: {
    ...
    ask_service_choice: 'Quel service souhaitez-vous ? {services}. Répondez par un numéro ou le nom.',
    service_picked: 'Parfait — {service}.',
    service_not_matched: 'Je n\'ai pas trouvé ce service. Options : {services}. Répondez par un numéro ou le nom.',
    price_list: 'Nos services : {items}.',
    price_list_empty: 'Aucun service configuré pour le moment. Réessayez bientôt.',
  ...
  pt: {
    ...
    ask_service_choice: 'Qual serviço deseja? {services}. Responda com um número ou o nome.',
    service_picked: 'Ótimo — {service}.',
    service_not_matched: 'Não consegui identificar o serviço. Opções: {services}. Responda com um número ou o nome.',
    price_list: 'Nossos serviços: {items}.',
    price_list_empty: 'Ainda não temos um menu de serviços. Tente novamente em breve.',
  ...
  ar: {
    ...
    ask_service_choice: 'أي خدمة تريد؟ {services}. رد برقم أو اسم الخدمة.',
    service_picked: 'تم — {service}.',
    service_not_matched: 'لم أستطع تحديد الخدمة. الخيارات: {services}. رد برقم أو اسم.',
    price_list: 'خدماتنا: {items}.',
    price_list_empty: 'لا توجد قائمة خدمات بعد. حاول لاحقًا.',
  ...
  it: {
    ...
    ask_service_choice: 'Quale servizio vuoi? {services}. Rispondi con un numero o il nome.',
    service_picked: 'Perfetto — {service}.',
    service_not_matched: 'Non ho riconosciuto il servizio. Opzioni: {services}. Rispondi con un numero o il nome.',
    price_list: 'I nostri servizi: {items}.',
    price_list_empty: 'Non abbiamo ancora un listino. Riprova più tardi.',
  ...
  ru: {
    ...
    ask_service_choice: 'Какую услугу хотите? {services}. Ответьте номером или названием.',
    service_picked: 'Отлично — {service}.',
    service_not_matched: 'Не удалось распознать услугу. Варианты: {services}. Ответьте номером или названием.',
    price_list: 'Наши услуги: {items}.',
    price_list_empty: 'Прайс пока не настроен. Попробуйте позже.',
