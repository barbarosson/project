...
const WORD_MARKERS: Array<[LocaleCode, RegExp]> = [
  ['tr', /\b(merhaba|selam|günaydın|iyi\s?günler|randevu|fiyat|saat|açık|kapalı|evet|hayır|teşekkür|lütfen|nasıl|nerede|ne\s?kadar|var\s?mı|yok\s?mu|bugün|yarın)\b/i],
