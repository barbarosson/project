/*
  # handle_po_received: use expenses category 'other' to avoid CHECK constraint

  If expenses_category_check still excludes 'purchase', trigger fails with 400.
  Use category 'other' so INSERT always succeeds; description still indicates PO.
*/
