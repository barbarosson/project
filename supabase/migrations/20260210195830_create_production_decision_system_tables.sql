/*
  ...
  1. Tables
    - production_recipes - BOM
    - production_recipe_items - Raw materials
    - ai_production_suggestions - AI recommendations
...
CREATE TABLE IF NOT EXISTS public.production_recipe_items (
    ...
    scrap_factor DECIMAL(5,4) DEFAULT 1.05,
    waste_percentage DECIMAL(5,2) DEFAULT 5.0,
...
CREATE TABLE IF NOT EXISTS public.ai_production_suggestions (
    ...
    cash_required DECIMAL(15,2),
    cash_runway_impact_days INTEGER,
