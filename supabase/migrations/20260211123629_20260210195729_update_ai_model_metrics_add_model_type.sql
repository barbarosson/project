/*
  ...
  Add missing columns to ai_model_metrics table for production decision system
*/
...
DO $$ BEGIN
    IF NOT EXISTS (
        ...
        AND table_name = 'ai_model_metrics' 
...
DO $$ BEGIN
    IF NOT EXISTS (
        ...
        WHERE table_schema = 'public' 
        AND table_name = 'ai_model_metrics' 
        AND column_name = 'precision_score'
    ) THEN
...
DO $$ BEGIN
    IF NOT EXISTS (
        ...
        WHERE table_schema = 'public' 
        AND table_name = 'ai_model_metrics' 
        AND column_name = 'training_duration_seconds'
    ) THEN
...
-- Create index on model_type if not exists
