/*
  # Fix RLS Policies for All ERP Tables
  Update inventory, invoices, transactions policies
*/
...
CREATE POLICY "Allow public to view inventory" ON inventory FOR SELECT TO public USING (true);
CREATE POLICY "Allow public to insert inventory" ON inventory FOR INSERT TO public WITH CHECK (true);
CREATE POLICY "Allow public to update inventory" ON inventory FOR UPDATE TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow public to delete inventory" ON inventory FOR DELETE TO public USING (true);
...
CREATE POLICY "Allow public to view invoices" ON invoices FOR SELECT TO public USING (true);
CREATE POLICY "Allow public to insert invoices" ON invoices FOR INSERT TO public WITH CHECK (true);
CREATE POLICY "Allow public to update invoices" ON invoices FOR UPDATE TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow public to delete invoices" ON invoices FOR DELETE TO public USING (true);
...
CREATE POLICY "Allow public to view transactions" ON transactions FOR SELECT TO public USING (true);
CREATE POLICY "Allow public to insert transactions" ON transactions FOR INSERT TO public WITH CHECK (true);
CREATE POLICY "Allow public to update transactions" ON transactions FOR UPDATE TO public USING (true) WITH CHECK (true);
CREATE POLICY "Allow public to delete transactions" ON transactions FOR DELETE TO public USING (true);
