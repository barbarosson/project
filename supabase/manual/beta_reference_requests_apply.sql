-- =============================================================================
-- Beta referans talepleri tablosu — TEK SEFERDE Supabase SQL Editor'de çalıştırın
-- Dashboard: https://app.supabase.com → Projeniz → SQL Editor → New query → Run
-- =============================================================================
...
-- Ek tablo izinleri (PostgREST / service role API)
GRANT ALL ON TABLE public.beta_reference_requests TO postgres, service_role;
